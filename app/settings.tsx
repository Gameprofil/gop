...
import { User, Bell, Shield, Globe, CircleHelp as HelpCircle, LogOut, ChevronRight, Moon, Volume2, Smartphone, Check, X, Bot, Mail, Phone, CreditCard as Edit, Save, Settings as SettingsIcon } from 'lucide-react-native';
...
export default function SettingsScreen() {
  ...
  const handleContact = (type: 'email' | 'phone') => {
    if (type === 'email') {
      Linking.openURL('mailto:gameprofile@op.pl');
    } else {
      Linking.openURL('tel:+48512636595');
    }
  };
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          >
            <View style={styles.settingLeft}>
              ...
              <Text style={styles.settingLabel}>Wszystkie powiadomienia</Text>
            </View>
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <View style={styles.settingRight}>
              <Text style={styles.settingValue}>gameprofile@op.pl</Text>
              <ChevronRight size={20} color="#888888" />
            </View>
          </TouchableOpacity>
          ...
          >
            ...
            <View style={styles.settingRight}>
              <Text style={styles.settingValue}>+48 512 636 595</Text>
              <ChevronRight size={20} color="#888888" />
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.appInfo}>
          ...
          <Text style={styles.appDescription}>Platforma skautingowa dla piłkarzy</Text>
          <Text style={styles.appAuthor}>Szymon Kunat</Text>
        </View>
