...
import { User, Users, Building, Briefcase } from 'lucide-react-native';
    ...
    >
        ...
        {profileTypes.map((type) => {
          ...
          return (
            <TouchableOpacity
              key={type.id}
              style={styles.card}
              onPress={() => handleProfileTypeSelect(type.id)}
              activeOpacity={0.8}
            >
              <LinearGradient
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>
          Zarejestruj się i rozpocznij swoją piłkarską przygodę
        </Text>
      </View>
    </LinearGradient>
  );
